...
# 
 set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets { D[0] } ]
 set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets { D[1] } ]
 set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets { D[2] } ]
 set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets { D[3] } ]
 set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets { Clk } ]
 set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets { Reset } ]
 set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets { Load } ]